...
OJK_REPORT_SOURCES = {
    "statistik_perbankan": {
        ...
        "format_data": (
            "File Excel (.xlsx) multi-sheet: satu workbook per bulan berisi "
            "belasan sheet/tabel terpisah (mis. 'Tabel 1' = total aset per "
            "kelompok bank, 'Tabel 5' = kredit per sektor ekonomi, dst). "
            "Perlu dibuka & dipilih sheet-nya satu per satu di Excel/pandas "
            "(pd.read_excel dengan parameter sheet_name)."
        ),
        "contoh_analisis": [
            "Tren pertumbuhan kredit & DPK bulanan (year-on-year / month-on-month)",
            "Rasio NPL sebagai indikator kualitas kredit industri perbankan",
            "Perbandingan CAR (permodalan) antar kelompok bank (BUKU 1-4)",
        ],
    },
    "statistik_perbankan_syariah": {
        ...
        "format_data": (
            "Sama seperti Statistik Perbankan konvensional: Excel multi-sheet "
            "per bulan, tapi istilahnya beda - 'pembiayaan' (bukan kredit), "
            "'FDR' (Financing to Deposit Ratio, setara LDR), 'NPF' (setara NPL)."
        ),
        "contoh_analisis": [
            "Perbandingan pertumbuhan pembiayaan syariah vs kredit konvensional",
            "Pangsa pasar (market share) perbankan syariah dari waktu ke waktu",
            "Tren rasio NPF sebagai indikator kualitas pembiayaan",
        ],
    },
    "statistik_iknb": {
        ...
        "format_data": (
            "Campuran Excel & PDF, biasanya terbit per triwulan (bukan "
            "bulanan seperti perbankan). Tabel dipecah per sub-sektor "
            "(asuransi jiwa, asuransi umum, dana pensiun, dst)."
        ),
        "contoh_analisis": [
            "Pertumbuhan premi asuransi & rasio klaim per sub-sektor",
            "Tren penyaluran pembiayaan multifinance (leasing/kredit kendaraan)",
            "Perkembangan jumlah & skala platform fintech P2P lending",
        ],
    },
    "statistik_pasar_modal": {
        ...
        "format_data": (
            "Umumnya PDF ringkasan statistik bulanan/triwulanan, kadang "
            "disertai lampiran Excel berisi daftar emiten & nilai transaksi."
        ),
        "contoh_analisis": [
            "Tren jumlah IPO baru & nilai dana yang dihimpun per tahun",
            "Pertumbuhan jumlah investor ritel pasar modal dari waktu ke waktu",
            "Perkembangan nilai aktiva bersih (NAB) reksa dana",
        ],
    },
}
